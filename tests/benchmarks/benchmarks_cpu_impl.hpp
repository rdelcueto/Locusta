...
#pragma omp simd reduction(+ : reduction_sum) linear(                          \
  evaluation_vector : DIMENSION_OFFSET * sizeof(TFloat))
...
#pragma omp simd reduction(+ : reduction_sum_b,                                \
                           reduction_sum_c) reduction(* : pow_a, pow_b)
