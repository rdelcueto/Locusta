...
#include "../src/evaluator/evaluator_cpu.h"
#include "../src/benchmarks/benchmarks_cpu.h"

#include "../src/population_set_cpu.h"
#include "../src/prngenerator/prngenerator_cpu.h"
#include "../src/ga/ga_solver_cpu.h"
