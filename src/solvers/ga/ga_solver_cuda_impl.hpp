...
namespace locusta {
    ...
    template<typename TFloat>
    void ga_solver_cuda<TFloat>::setup_solver() {
    ...
    template<typename TFloat>
    void ga_solver_cuda<TFloat>::teardown_solver() {
        delete [] _prn_sets;
        CudaSafeCall(cudaFree(_dev_bulk_prns));
    }

    template<typename TFloat>
    void ga_solver_cuda<TFloat>::setup_operators(BreedCudaFunctor<TFloat> * breed_functor_ptr,
    ...
    template<typename TFloat>
    void ga_solver_cuda<TFloat>::solver_config(uint32_t migration_step,
    ...
    template<typename TFloat>
    void ga_solver_cuda<TFloat>::transform() {
    ...
    template<typename TFloat>
    void ga_solver_cuda<TFloat>::elite_population_replace() {
