...
namespace locusta {
    ...
    template <typename TFloat>
    __global__
    void de_tournament_selection_kernel(const uint32_t SELECTION_SIZE,
    ...
    (const uint32_t ISLES,
     ...
     uint32_t * candidates_reservoir_array) {
        de_tournament_selection_kernel
            <<<ISLES, AGENTS>>>
            (SELECTION_SIZE,
             SELECTION_P,
             fitness_array,
    ...
    template
    void de_tournament_selection_dispatch<float>
    (const uint32_t ISLES,
     const uint32_t AGENTS,
     const uint32_t SELECTION_SIZE,
    ...
    template
    void de_tournament_selection_dispatch<double>
    (const uint32_t ISLES,
     const uint32_t AGENTS,
     const uint32_t SELECTION_SIZE,
