...
namespace locusta {
  ...
  __global__
  void reset_velocity_kernel(const uint32_t DIMENSIONS,
  ...
  template
  void reset_velocity_dispatch<float>(const uint32_t ISLES,
                                      const uint32_t AGENTS,
                                      const uint32_t DIMENSIONS,
  ...
  template
  void reset_velocity_dispatch<double>(const uint32_t ISLES,
                                       const uint32_t AGENTS,
                                       const uint32_t DIMENSIONS,
